...
public class HomeActivity extends AppCompatActivity implements OnNavigationItemSelectedListener,AdapterView.OnItemClickListener {

    ListView adsList;

    ArrayList<AdsModel> adsModels = new ArrayList<>();

    String baseurl = "http://192.168.43.25/classifieds";
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
          Intent in = new Intent(this,detailsAdd.class);
            in.putExtra("relatedValues",i);
            startActivity(in);
        // new FetchPostAttempt1().execute(baseurl+"/get_posts.php");
    }
//    class FetchPostAttempt1 extends AsyncTask<String,Void,String>
//    {
//
//        ProgressDialog pd;
//
...
//                        String postprice = jo.getString("post_price");
//                        //String post_image =  baseurl + jo.getString("post_image") ;
//
//
//
//                        AdsModel ad = new AdsModel(id,title,description,postdate,postprice, " ");
//
//                        adsModels.add(ad);
//
//
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent i1 = new Intent(HomeActivity.this, cars.class);
